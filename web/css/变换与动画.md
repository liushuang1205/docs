...
![Image 1](_media/33296cb4665c4b0f8afc6c466ecaa97e.png)
...
还记得第 9 章选择器的切换按钮的刹车动画吗？点击按钮后，圆点从左到右有一个细微的刹车动画，这个不是通过 JS 捣鼓出来的，而是笔者细心地调制了一个缓动函数`cubic-bezier(.4,.4,.25,1.35)`实现的。具体实现可通过笔者推荐的网站自行调制喔。
