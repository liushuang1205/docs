...
![Image 1](_media/280266bb4f45426ea166a654e02f3036.png)
...
![Image 1](_media/2d8a456629e547fc9fbf63976f1ecd94.png)
...
![Image 1](_media/2582d59f666544b4ade10cc2484ae344.png)
...
这个功能对 swiper 属性进行设置 `:autoplay="true" :duration="500" :circular="true" :vertical="true"`，自动滚动，滑动动画时长 500 毫秒，采用衔接滑动，滑动方向为纵向。即可实现滚动信息展示。
...
![Image 1](_media/1dcbcc76aed44579850ae558c1ba5c7f.png)
...
![Image 1](_media/e8f215dead3a4baf901948ac6dd7fcfc.png)

作为一款应用，应用内的信息提示一般会展现在底部导航栏上，Uniapp 支持设置 TabBar 上的元素以及角标等信息，统一了 h5，小程序，app 的设置角标 API。

![Image 1](_media/292548b368dd43cab02f225462978f0b.png)

`uni.setTabBarBadge` 这个 API 在 **非 tabbar** 页面上调用会失效，因此我们需要在 common/js/util.js 封装一个方法由几个 tabbar 页面上调用。结合 Vuex 的状态管理全局管理角标信息。
...
4.  本章代码 [uni-course-实战开发云村页][uni-course-]。

[img]: https://s.poetries.work/images/16f374d21d95fbef.png
[image-20210215154852615]: https://s.poetries.work/images/image-20210215154852615.png
[image-20210215154913770]: https://s.poetries.work/images/image-20210215154913770.png
[img 1]: https://s.poetries.work/images/16f374e899d8abd0.png
[image-20210215154950380]: https://s.poetries.work/images/image-20210215154950380.png
[img 2]: https://s.poetries.work/images/16f374f26f0ce1d4.png
[uni-course-]: https://github.com/front-end-class/uniapp-music-code/blob/master/uni-course-%E5%AE%9E%E6%88%98%E5%BC%80%E5%8F%91%E4%BA%91%E6%9D%91%E9%A1%B5.zip
