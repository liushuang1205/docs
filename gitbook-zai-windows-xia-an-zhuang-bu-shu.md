...
[https://nodejs.org/dist/v12.16.3/node-v12.16.3-x64.msi](https://nodejs.org/dist/v12.16.3/node-v12.16.3-x64.msi)
...
有的人说会输出gitbook版本号，可是我的这个电脑什么都没有输出。 这样就算安装完成了

#### 1、手动创建目录创建好之后在CMD中切换到这个目录下
...
2、创建gitbook空间 gitbook init 1 过程：
