...
| 有值 | 属性名-有值 | 商品名称-有值 | 数据列**ABCDE** |
| 没值 | 属性名-没值 | 商品名称-没值 | 数据列**F** |
| 为空 | 属性名-为空 | 商品名称-为空 | 数据列**E** |
| 不为空 | 属性名-不为空 | 商品名称-不为空 | 数据列**ABCDF** |
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/筛选条件/绝对时间.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/筛选条件/相对当前时间点.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/筛选条件/相对当前时间区间.png)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 事件名 | 支付订单 | 支付订单 | 支付订单 | 支付订单 | 支付订单 | 支付订单 |
| 是否首次支付 | True | False | True | True | False | NULL |
