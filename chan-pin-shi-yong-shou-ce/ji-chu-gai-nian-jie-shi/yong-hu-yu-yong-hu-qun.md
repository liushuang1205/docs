...
在数据分析平台内，我们用ID来标识一个用户，这个ID可以划分为**平台ID**，**匿名ID**，**业务ID**三种，具体说明可以参考[用户的标识与关联](../../ji-shu-zhi-nan/ji-chu-zhi-shi/yong-hu-de-biao-shi-yu-guan-lian.md)。
...
用户群的划分主要依赖于[用户分群](../yong-hu-fen-qun.md)功能，划分用户群的意义很明确---**精细化运营**。
