...
看板，是数据可视化的最终载体。该模块支持10个高级分析模型分析结果的展示，不同角色均可将需要监测数据指标以[书签](https://github.com/liushuang1205/docs/tree/dfedffd19e7a2c476283d11b3f29313256234ed4/书签.md)的形式添加到看板中，构建自定义看板，以满足自身的数据追踪需求。
...
进入[书签管理模块](https://github.com/liushuang1205/docs/tree/dfedffd19e7a2c476283d11b3f29313256234ed4/书签.md)，找到目标书签后，点击书签后方的**编辑**按钮，在同时添加到以下看板一栏中，找到目标看板后点击勾选，点击确定后，此书签即添加至需要添加的看板中。
