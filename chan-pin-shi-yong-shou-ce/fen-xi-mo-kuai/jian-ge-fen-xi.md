...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/间隔分析界面.png)

**间隔分析界面概览**

## 查询条件配置方法

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/起始行为与目标行为.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/行为筛选.gif)

**起始行为与目标行为**

点击**增加筛选**按钮，可以单独对起始行为或目标行为添加筛选条件，筛选的属性来源于其携带的事件属性与全部的用户属性，具体的筛选条件配置方法与计算逻辑可参考[筛选条件](../ji-chu-gai-nian-jie-shi/shai-xuan-tiao-jian.md)。

> 例如起始行为选择提交订单，需要筛选出**双11促销活动**的订单，可以在起始行为后方点击增加筛选按钮，配置筛选条件：**活动名称-等于-双11促销活动**。配置完成后只有双11促销活动的提交订单数据才会纳入计算。

### 设置关联属性

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/设置关联属性.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/公共筛选条件.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/分析维度.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/分析用户群.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/时间范围选择.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/保存与下载.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/盒须图.png)

**盒须图图例**

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/数据例.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/间隔分析/行为序列.png)
