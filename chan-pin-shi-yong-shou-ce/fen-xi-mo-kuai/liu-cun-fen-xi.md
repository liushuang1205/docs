...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/留存分析/留存分析界面.png)

**留存分析界面**

## 查询条件配置方法

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/留存分析/配置初始行为及后续行为.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/初始行为或后续行为的事件属性筛选.gif)

**初始行为或后续行为的事件属性筛选**

点击**增加筛选**按钮，可以单独对初始行为或后续行为添加筛选条件，筛选的属性来源于其携带的事件属性与全部的用户属性，具体的筛选条件配置方法与计算逻辑可参考[筛选条件](../ji-chu-gai-nian-jie-shi/shai-xuan-tiao-jian.md)。

> 例如初始行为选择注册，需要筛选出**手机号注册**的用户，可以在起始行为后方点击增加筛选按钮，配置筛选条件：**注册方式-等于-手机号**。配置完成后执行查询，则只有手机号注册的用户才会纳入计算。

### 设置关联属性

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/设置关联属性.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/用户筛选.gif)

**用户筛选**

租户可以使用用户筛选功能对参与计算的用户进行筛选，用户属性的筛选结构为**用户属性-逻辑运算关系-属性值**，通过用户属性的筛选，我们可以针对某个特定的用户群体进行分析，例如选择**城市**等于**北京市**，那么将会对北京市的用户进行针对性的留存分析，多个用户属性之间可以选择**逻辑关系**，详情参见[筛选条件](../ji-chu-gai-nian-jie-shi/shai-xuan-tiao-jian.md)。

用户筛选过程先于留存模型计算，即先将选定用户群根据筛选条件进行筛选，然后以筛选后的用户群为基础进行留存计算

## 分析指标

![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/留存分析/分析指标.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/分析维度.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/时间范围选择.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图存分析/保存与下载.png)
...
![](c:/Users/EDZ/Desktop/卓尔数科产品文档/数据分析平台产品文档/配图/留存分析/留存用户.png)
...
![](c:/Users/EDZ/Desktop/卓尔数科产品文档/数据分析平台产品文档/配图/留存分析/流失用户.png)
