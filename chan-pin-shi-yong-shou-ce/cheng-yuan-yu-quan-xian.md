...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/成员与权限管理页面.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/成员与角色.png)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/添加成员.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/成员操作.gif)
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/新建角色.gif)
...
| 编辑看板和书签 | 允许编辑所有概览和书签，包含对看板及看板组的增删改，看板详情页内容的增删改，所有书签的编辑等 | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| 数据结果导出 | 所有高级分析（除路径分析）中数据导出成Excel的功能 | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |


| 查询结果保存到分群 | 高级分析中结果中，用户数据快速保存到分群的功能 | √ | √ | √ | √ | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |


| 事件分析 | 对高级分析模块进行操作，查询结果等 | √ | √ | √ | √ | √ |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| 新建分群 | 新建用户分群，并对自己创建的分群进行编辑和删除等 | √ | √ | √ | √ | √ |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |


| 编辑分群 | 管理可查看范围内的所有分群，包括编辑，删除，暂停，启用等 | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| 元事件管理 | 包括对元事件，事件属性，用户属性，物品属性显示名，展示状态等的管理，字典上传/删除等 | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |


| 虚拟事件管理 | 包括新建，修改，删除自定义的虚拟事件 | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |


| Session管理 | 包括新建，修改，删除自定义的Session | √ | √ | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| 编辑预警规则 | 包括新增预警规则，编辑预警规则的启动状态，删除预警规则等 | √ | √ | × | √ | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| 编辑成员与角色 | 新建角色并编辑角色权限，新增，邀请，管理成员等 | √ | × | × | × | × |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
![](https://github.com/liushuang1205/docs/tree/0575b92213ff4647cd147fe3e6fcee0507775a5c/配图/成员与权限/角色成员管理.gif)
