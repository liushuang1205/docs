...
![](.\配图\自定义查询\自定义查询界面.png)

<center><font color=gray size=2><b>自定义查询界面</b></font></center>

## 标签释义

![](.\配图\自定义查询\自定义查询界面顶部标签.png)

<center><font color=gray size=2><b>自定义查询界面顶部标签</b></font></center>
...
<center><font color=gray size=2><b>表名与字段名</b></font></center>

在自定义查询界面的左侧，展示当前项目的Event表与User表的表名与表内包含的所有字段名，点击表名即可展开该表内包含的所有字段名。

### 执行查询

![](.\配图\自定义查询\SQL语句查询.png)

<center><font color=gray size=2><b>SQL语句查询</b></font></center>
...
<center><font color=gray size=2><b>保存查询条件</b></font></center>
...
<center><font color=gray size=2><b>执行新查询</b></font></center>
